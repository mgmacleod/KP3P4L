...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 303.5, 242.0, 150.0, 20.0 ],
									"text" : "59. 18. 187. 146."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 144.0, 221.0, 50.0 ],
									"text" : "if $i1 == 1 && ($i2 >= 59 && $i2 <= 246) && ($i3 >= 18 && $i3 <= 164) then 127 else 0"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 88.0, 100.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 160.25, 100.0, 43.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 119.25, 100.0, 39.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 92.75, 200.0, 92.0, 34.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 3,
									"numoutlets" : 0,
									"patching_rect" : [ 179.25, 318.0, 54.0, 22.0 ],
									"text" : "ctlout 92"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 179.25, 282.0, 44.0, 15.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 179.25, 242.0, 47.0, 22.0 ],
									"text" : "ctlin 92"
								}
...
,
					"patching_rect" : [ 72.75, 230.0, 76.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.75, 143.0, 32.5, 23.0 ],
					"text" : "poll"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 137.875, 143.0, 55.0, 23.0 ],
					"text" : "mode 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 72.75, 188.0, 133.0, 23.0 ],
					"text" : "mousestate"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 72.75, 69.0, 149.25, 22.0 ],
					"text" : "t b b b"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 50.5, 342.0, 54.0, 22.0 ],
									"text" : "pgmout"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 3,
									"numoutlets" : 0,
									"patching_rect" : [ 136.5, 342.0, 54.0, 22.0 ],
									"text" : "ctlout 32"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 169.5, 173.0, 150.0, 34.0 ],
									"text" : "translate back to separate bank and program number"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 88.0, 185.0, 67.5, 22.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 50.5, 227.0, 56.5, 22.0 ],
									"text" : "- 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 169.5, 260.0, 29.5, 22.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 136.5, 260.0, 29.5, 22.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 136.5, 221.0, 85.0, 22.0 ],
									"text" : "sel -1 127"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 136.5, 132.0, 119.0, 36.0 ],
									"text" : "if $i1 <= 127 then -1 else 127"
								}
...
,
					"patching_rect" : [ 603.5, 174.0, 132.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 25.5, 74.5, 41.0, 22.0 ],
									"text" : "pgmin"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 74.5, 74.5, 47.0, 22.0 ],
									"text" : "ctlin 32"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 149.5, 89.0, 85.0, 34.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 50.0, 178.0, 43.5, 22.0 ],
									"text" : "+ 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.5, 136.5, 106.0, 36.0 ],
...
,
					"patching_rect" : [ 603.5, 110.5, 91.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 213.0, 230.0, 80.0, 29.0 ],
					"text" : "XY Pad"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 603.5, 144.0, 100.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 59.0, 1.0, 187.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "Program Select",
							"parameter_mmax" : 149,
							"parameter_shortname" : "ProgramMenu",
							"parameter_type" : 2
						}
...
,
					"patching_rect" : [ 203.0, 127.5, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 603.5, 66.0, 102.0, 20.0 ],
					"text" : "program change"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 449.0, 357.0, 54.0, 22.0 ],
					"text" : "ctlout 13"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 318.0, 357.0, 54.0, 22.0 ],
					"text" : "ctlout 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 449.0, 121.5, 47.0, 22.0 ],
					"text" : "ctlin 13"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 318.0, 126.0, 47.0, 22.0 ],
					"text" : "ctlin 12"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 449.0, 151.5, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 318.0, 156.5, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 582.0, 54.0, 22.0 ],
					"text" : "ctlout 95"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 548.0, 90.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 22.0, 449.0, 47.0, 22.0 ],
					"text" : "ctlin 95"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 480.0, 90.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 318.0, 605.75, 54.0, 22.0 ],
					"text" : "ctlout 93"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 318.0, 442.75, 47.0, 22.0 ],
					"text" : "ctlin 93"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 168.0, 574.0, 54.0, 22.0 ],
					"text" : "ctlout 94"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 168.0, 466.0, 47.0, 22.0 ],
					"text" : "ctlin 94"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.5, 16.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.0, 413.0, 29.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.5, 129.0, 29.0, 18.0 ],
					"text" : "Hold",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 22.0, 514.25, 23.71875, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 14.140625, 145.0, 23.71875, 23.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 168.0, 508.0, 41.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.5, 3.0, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 318.0, 494.75, 47.0, 98.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 53.0, 54.0, 77.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 318.0, 188.0, 150.0, 150.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 59.0, 18.0, 187.0, 146.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-53", 0 ],
					"midpoints" : [ 147.375, 178.0, 82.25, 178.0 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 212.5, 178.0, 327.5, 178.0 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-58::obj-30" : [ "Pad On/Off", "PadOnOff", 0 ],
			"obj-6" : [ "Level", "Level", 0 ],
